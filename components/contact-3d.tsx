...
export function Contact3D() {
  ...
  useEffect(() => {
    ...
    // Criar a esfera de contato
    const sphere = document.createElement("div")
    sphere.className = "contact-sphere"
    container.appendChild(sphere)

    // Criar os ícones de contato
    const icons: ContactIcon[] = [
      {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/miguel-eustaquio-77405b326",
        logoPath:
      ...
      {
        name: "Instagram",
        url: "https://www.instagram.com/migueldiasc_",
        logoPath:
    ...
    icons.forEach((icon, index) => {
      ...
      element.className = "contact-icon"
      element.href = icon.url
      element.target = "_blank"
      element.rel = "noopener noreferrer"

      // Criar o SVG para o ícone
      ...
      path.setAttribute("d", icon.logoPath)
      ...
      element.style.transform = `rotateY(${(index * 360) / icons.length}deg) translateZ(150px)`
